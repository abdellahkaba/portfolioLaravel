<div
    x-data="{categories: {{ json_encode($categories) }}}" :class="selectedTab == 'all' || categories.includes(selectedTab) ? 'block' : 'hidden'"
...
>
    <div class="relative mb-12">
        ...
        <div class="text-center bg-white dark:bg-slate-800 relative z-10 py-9 px-3 rounded-lg shadow-lg mx-7 -mt-4 h-[260px]">
            ...
            <x-button-link :href="$github" variant="outline-primary" class="text-white hover:bg-info">Voir les détails</x-button-link>
        </div>
    </div>
</div>