      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
        <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
          <div class="max-w-[570px] mb-12 lg:mb-0">
            <h2 class="text-white dark:text-gray-100 mb-6 uppercase font-bold text-[32px] sm:text-[40px] lg:text-[36px] xl:text-[40px]">
            POUR LES ENQUÊTES COMMERCIALES
            </h2>
            <p class="text-white  dark:text-gray-200 leading-relaxed mb-9">
            ...
            <div class="flex mb-8 max-w-[370px] w-full">
              ...
              <div class="w-full">
                <h4 class="font-bold text-white dark:text-gray-200 text-xl mb-1">
                  Adress Email
                </h4>
                <p class="text-white  dark:text-gray-300">themakcx@gmail.com ou abdallahkaba98@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
        <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
          <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
            ...
            " x-on:submit.prevent="submitForm">
              ...
              @csrf
              <div class="mb-6">
                <x-forms.input placeholder="Nom complet" name="name" x-model="formData.name" ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
                <template x-if="errors.name">
                  <div x-text="errors.name[0]" class="text-red-500"></div>
                </template>
              </div>
              <div class="mb-6">
                <x-forms.input type="email" placeholder="Adresse email" name="email" x-model="formData.email" ::class="errors.email ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
