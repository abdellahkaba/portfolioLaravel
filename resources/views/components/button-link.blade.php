<a 
    ...
    {{ 
        $attributes->class([
            ...
            'hover:bg-primary hover:border-primary hover:text-white' => $variant === 'outlin-primary',
            'hover:bg-red-700 hover:border-red-700 hover:text-white' => $variant === 'outlin-red',
